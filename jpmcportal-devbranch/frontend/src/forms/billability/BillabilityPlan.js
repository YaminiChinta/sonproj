...
const BillabilityPlan = (props) => {
  ...
  const getBillabilityData = () => {
    if (selPractice && selPractice != "" && selLOB && selLOB != "") {
      DataService.getBillablePlan(selPractice, selLOB).then(
        (response) => {
...
export default BillabilityPlan;
