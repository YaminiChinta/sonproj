...
public class EmailUtil {
	...
	public void sendPanelistNominationDetail(JavaMailSender mailSender, AddPanelistRequest panelist,
			String emailToAddress, String emailFromAddress) throws MessagingException, UnsupportedEncodingException {
		String toAddress = emailToAddress;
		String fromAddress = "narenkgcts@outlook.com"; // ; password --> @DevTeam
		String senderName = "Account Admin";
		String subjectAssignmentsEnding = "!! Alert !! - Associate nominated for Interview Drive";
		StringBuffer email = new StringBuffer("Dear,<br>" + " Associate nominated for your Interview Drive:<br>");
		...
		email.append("<td>");
		email.append("Skill Id");
		email.append("</td>");

		email.append("<td>");
		email.append("Availability From");
		email.append("</td>");

		email.append("<td>");
		email.append("Availability To");
		email.append("</td>");
		...
		email.append("<td>");
		email.append(panelist.getAssociateId());
		email.append("</td>");

		email.append("<td>");
		email.append(panelist.getPanelistName());
		email.append("</td>");

		email.append("<td>");
		email.append(panelist.getSkillId());
		email.append("</td>");

		email.append("<td>");
		email.append(panelist.getAvailabilityFrom());
		email.append("</td>");

		email.append("<td>");
		email.append(panelist.getAvailabilityTo());
		email.append("</td>");

		email.append("<tr>");

		email.append("</table>");
		email.append("<br>" + "Thank you,<br>" + "Drive Team");
