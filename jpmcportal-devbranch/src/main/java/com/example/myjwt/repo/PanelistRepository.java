...
public interface PanelistRepository extends JpaRepository<PanelNominee, Long> {
	...
	public PanelNominee findByAssociateId(Long associateId);
	...
	@Query(value="SELECT * from panel_nominee where associate_id=?2 and interview_drive_id=?1",nativeQuery = true)				
